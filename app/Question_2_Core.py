...
for e in range(0,N_episodes):
    Dataset.append(simulate_episode(init_prob_matrix = Prob_matrix, n_steps_max = 100, budget = Budget, perfect_nodes = []))
...
SuperDataset = []
for e in range(0,N_episodes):
    SuperDataset.append(simulate_episode(init_prob_matrix = Prob_matrix, n_steps_max = 100, budget = Budget, perfect_nodes = estimated_best_nodes))
