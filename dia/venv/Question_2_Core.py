...
for edge in Edges_info[1]:
    Prob_matrix[edge.head.num, edge.tail.num] = edge.proba_activation
Dataset = []
...
estimated_best_nodes = estimate_node_message(dataset = Dataset, message = Message, list_nodes = Nodes_info[2])
